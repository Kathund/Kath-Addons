...
class Settings {
  ...
  @SwitchProperty({
    ...
    description:
      '&n&4Usage of this may result in a mute! Use at your own risk\n&rWill post peoples fails messages in all and party chat',
    category: 'Dungeons',
    subcategory: 'General',
  })
  ...
  emojisDownload() {
    java.awt.Desktop.getDesktop().browse(
      new java.net.URI('https://github.com/Kathund/kath/releases/download/v1.4.0/emojiPack.zip')
    );
  }
  ...
  @SwitchProperty({
    name: 'Anti Combo',
    description:
      'A settings that makes it so u cant be comboed and it will auto combo for u (hides the combo messages from the grandma wolf)',
    category: 'Chat',
    subcategory: 'General',
  })
  chatAntiCombo = false;

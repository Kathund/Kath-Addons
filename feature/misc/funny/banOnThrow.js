      ...
      if (config.miscBanType === 0) {
        if (config.miscBanLength === 0) {
          ...
          Client.getMinecraft()
            ...
            .func_150718_a(
              new ChatComponentText(
                `§cYou are temporarily banned for §f13d 23h 59m 59s§c from this server!\n§r\n§7Reason: §fCheating through the use of unfair game advantages.\n§7Find out more: §b§nhttps://www.hypixel.net/appeal\n§r\n§7Ban ID: §f#${banID}\n§7Sharing your Ban ID may affect the processing of your appeal!`
              )
            );
          ...
          Client.getMinecraft()
            ...
            .func_150718_a(
              new ChatComponentText(
                `§cYou are temporarily banned for §f89d 23h 59m 59s§c from this server!\n§r\n§7Reason: §fCheating through the use of unfair game advantages.\n§7Find out more: §b§nhttps://www.hypixel.net/appeal\n§r\n§7Ban ID: §f#${banID}\n§7Sharing your Ban ID may affect the processing of your appeal!`
              )
            );
          ...
          Client.getMinecraft()
            ...
            .func_150718_a(
              new ChatComponentText(
                `§cYou are temporarily banned for §f179d 23h 59m 59s§c from this server!\n§r\n§7Reason: §fCheating through the use of unfair game advantages.\n§7Find out more: §b§nhttps://www.hypixel.net/appeal\n§r\n§7Ban ID: §f#${banID}\n§7Sharing your Ban ID may affect the processing of your appeal!`
              )
            );
        ...
        if (config.miscBanType === 0) {
          if (config.miscBanLength === 0) {
            Client.getMinecraft()
              ...
              .func_150718_a(
                new ChatComponentText(
                  `§cYou are temporarily banned for §f${helperFunction.calculateRemainingTime(
                    helperFunction.data.banTimestamp
                  )}§c from this server!\n§r\n§7Reason: §fCheating through the use of unfair game advantages.\n§7Find out more: §b§nhttps://www.hypixel.net/appeal\n§r\n§7Ban ID: §f#${banID}\n§7Sharing your Ban ID may affect the processing of your appeal!`
                )
              );
          } else if (config.miscBanLength === 1) {
